...
async function main() {
  ...
  const cursosData = [
    ...
    { codigo: 'EE-102', nombre: 'Introducción a la Programación', creditos: 3, horasTeoria: 2, horasPractica: 0, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 1, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    ...
    { codigo: 'EG-205', nombre: 'Física General', creditos: 4, horasTeoria: 2, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 2, departamento: 'Dpto. de Física', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EE-201', nombre: 'Programación Orientada a Objetos I', creditos: 4, horasTeoria: 2, horasPractica: 0, horasLaboratorio: 4, numGruposLaboratorio: 2, ciclo: 2, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    
    // Ciclo III
    { codigo: 'EE-301', nombre: 'Sistémica', creditos: 3, horasTeoria: 1, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 3, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EP-303', nombre: 'Matemática Aplicada', creditos: 3, horasTeoria: 1, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 3, departamento: 'Dpto. de Matemáticas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EP-304', nombre: 'Física Electrónica', creditos: 3, horasTeoria: 1, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 3, departamento: 'Dpto. de Física', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EE-302', nombre: 'Programación Orientada a Objetos II', creditos: 4, horasTeoria: 2, horasPractica: 0, horasLaboratorio: 4, numGruposLaboratorio: 2, ciclo: 3, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EL-301', nombre: 'Ingeniería Gráfica (e)', creditos: 3, horasTeoria: 1, horasPractica: 1, horasLaboratorio: 3, numGruposLaboratorio: 2, ciclo: 3, departamento: 'Dpto. de Ing. Sistemas', condicion: 'E', requiereLaboratorio: true },

    // Ciclo IV
    { codigo: 'EE-401', nombre: 'Diseño Web', creditos: 3, horasTeoria: 1, horasPractica: 1, horasLaboratorio: 3, numGruposLaboratorio: 2, ciclo: 4, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EP-402', nombre: 'Pensamiento de Diseño', creditos: 3, horasTeoria: 1, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 4, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EE-402', nombre: 'Sistemas Digitales', creditos: 3, horasTeoria: 1, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 4, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EE-403', nombre: 'Estructura de Datos Orientado a Objetos', creditos: 4, horasTeoria: 2, horasPractica: 1, horasLaboratorio: 3, numGruposLaboratorio: 2, ciclo: 4, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EL-401', nombre: 'Computación Gráfica y Visual (e)', creditos: 3, horasTeoria: 1, horasPractica: 1, horasLaboratorio: 3, numGruposLaboratorio: 2, ciclo: 4, departamento: 'Dpto. de Ing. Sistemas', condicion: 'E', requiereLaboratorio: true },
    { codigo: 'EL-402', nombre: 'Plataformas Tecnológicas (e)', creditos: 3, horasTeoria: 2, horasPractica: 0, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 4, departamento: 'Dpto. de Ing. Sistemas', condicion: 'E', requiereLaboratorio: true },

    // Ciclo V
    { codigo: 'EE-501', nombre: 'Tecnologías Web', creditos: 3, horasTeoria: 1, horasPractica: 1, horasLaboratorio: 3, numGruposLaboratorio: 2, ciclo: 5, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EE-502', nombre: 'Ingeniería de Datos I', creditos: 4, horasTeoria: 2, horasPractica: 1, horasLaboratorio: 3, numGruposLaboratorio: 2, ciclo: 5, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EE-503', nombre: 'Arquitectura y Organización de Computadoras', creditos: 3, horasTeoria: 1, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 5, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EE-504', nombre: 'Sistemas de Información', creditos: 4, horasTeoria: 2, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 5, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },

    // Ciclo VI
    { codigo: 'EE-601', nombre: 'Sistemas Inteligentes', creditos: 3, horasTeoria: 1, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 6, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EP-602', nombre: 'Ingeniería Económica', creditos: 3, horasTeoria: 1, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 6, departamento: 'Dpto. de Ing. Industrial', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EE-602', nombre: 'Ingeniería de Datos II', creditos: 4, horasTeoria: 2, horasPractica: 1, horasLaboratorio: 3, numGruposLaboratorio: 2, ciclo: 6, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EE-603', nombre: 'Sistemas Operativos', creditos: 3, horasTeoria: 1, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 6, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EE-604', nombre: 'Ingeniería de Requerimientos', creditos: 3, horasTeoria: 1, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 6, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    ...
    { codigo: 'EE-701', nombre: 'Gestión de Servicios de TIC', creditos: 3, horasTeoria: 1, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 7, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EE-702', nombre: 'Planeamiento Estratégico de la Información', creditos: 3, horasTeoria: 1, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 7, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EE-703', nombre: 'Redes y Comunicaciones I', creditos: 3, horasTeoria: 1, horasPractica: 1, horasLaboratorio: 3, numGruposLaboratorio: 2, ciclo: 7, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EE-704', nombre: 'Ingeniería del Software I', creditos: 4, horasTeoria: 2, horasPractica: 1, horasLaboratorio: 3, numGruposLaboratorio: 2, ciclo: 7, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EL-702', nombre: 'Negocios Electrónicos (e)', creditos: 3, horasTeoria: 2, horasPractica: 0, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 7, departamento: 'Dpto. de Ing. Sistemas', condicion: 'E', requiereLaboratorio: true },

    // Ciclo VIII
    { codigo: 'EE-801', nombre: 'Seguridad de la Información', creditos: 3, horasTeoria: 1, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 8, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EE-802', nombre: 'Internet de las Cosas', creditos: 3, horasTeoria: 1, horasPractica: 1, horasLaboratorio: 3, numGruposLaboratorio: 2, ciclo: 8, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EE-803', nombre: 'Inteligencia de Negocios', creditos: 3, horasTeoria: 1, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 8, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EE-804', nombre: 'Redes y Comunicaciones II', creditos: 3, horasTeoria: 1, horasPractica: 1, horasLaboratorio: 3, numGruposLaboratorio: 2, ciclo: 8, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EE-805', nombre: 'Ingeniería del Software II', creditos: 4, horasTeoria: 2, horasPractica: 1, horasLaboratorio: 3, numGruposLaboratorio: 2, ciclo: 8, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },

    // Ciclo IX
    { codigo: 'EE-901', nombre: 'Gestión de Proyectos de TIC', creditos: 1, horasTeoria: 1, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 9, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EE-902', nombre: 'Auditoría Informática', creditos: 3, horasTeoria: 1, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 9, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EI-901', nombre: 'Tesis I', creditos: 4, horasTeoria: 2, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 9, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EE-903', nombre: 'Analítica de Negocios', creditos: 3, horasTeoria: 1, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 9, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EE-904', nombre: 'Computación en la Nube', creditos: 3, horasTeoria: 1, horasPractica: 1, horasLaboratorio: 3, numGruposLaboratorio: 2, ciclo: 9, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EL-901', nombre: 'Emprendedurismo Tecnológico (e)', creditos: 3, horasTeoria: 2, horasPractica: 0, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 9, departamento: 'Dpto. de Ing. Sistemas', condicion: 'E', requiereLaboratorio: true },
    { codigo: 'EL-902', nombre: 'Hackeo Ético (e)', creditos: 3, horasTeoria: 2, horasPractica: 0, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 9, departamento: 'Dpto. de Ing. Sistemas', condicion: 'E', requiereLaboratorio: true },

    // Ciclo X
    { codigo: 'EE-X02', nombre: 'Gobierno de TIC', creditos: 3, horasTeoria: 1, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 10, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EI-X01', nombre: 'Tesis II', creditos: 4, horasTeoria: 2, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 10, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    { codigo: 'EE-X03', nombre: 'Arquitectura Empresarial', creditos: 3, horasTeoria: 1, horasPractica: 2, horasLaboratorio: 2, numGruposLaboratorio: 2, ciclo: 10, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
    ...
    { codigo: 'EE-X05', nombre: 'Prácticas Pre Profesionales', creditos: 4, horasTeoria: 2, horasPractica: 1, horasLaboratorio: 3, numGruposLaboratorio: 2, ciclo: 10, departamento: 'Dpto. de Ing. Sistemas', requiereLaboratorio: true, condicion: 'O' },
  ];
  ...
  const docentesData = [
    ...
    { nombre: 'Camilo Suarez Rebaza', email: 'csuarez@unitru.edu.pe', categoria: CategoriaDocente.AUXILIAR, tipo: TipoDocente.NOMBRADO, antiguedad: new Date('2018-08-15'), dni: '24567890', codigoIBM: 'IBM013', modalidad: ModalidadDocente.TIEMPO_PARCIAL, horasContrato: 20, departamentoId: deptoSistemas.id, gradoAcademico: 'Magíster', especialidad: 'Plataformas y Hackeo', experienciaAnios: 7 },
    ...
    { nombre: 'Dr. Matematico Externo', email: 'math@unitru.edu.pe', categoria: CategoriaDocente.PRINCIPAL, tipo: TipoDocente.CONTRATADO, antiguedad: new Date('2000-01-01'), dni: '57890123', codigoIBM: 'IBM016', modalidad: ModalidadDocente.TIEMPO_PARCIAL, horasContrato: 20, departamentoId: deptoMatematicas.id, gradoAcademico: 'Doctor', especialidad: 'Matemática Pura', experienciaAnios: 25 },
    { nombre: 'Mg. Fisico Externo', email: 'physics@unitru.edu.pe', categoria: CategoriaDocente.ASOCIADO, tipo: TipoDocente.CONTRATADO, antiguedad: new Date('2010-01-01'), dni: '68901234', codigoIBM: 'IBM017', modalidad: ModalidadDocente.TIEMPO_PARCIAL, horasContrato: 12, departamentoId: deptoFisica.id, gradoAcademico: 'Magíster', especialidad: 'Física', experienciaAnios: 15 },
  ];
