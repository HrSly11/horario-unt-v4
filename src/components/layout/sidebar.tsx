...
export function Sidebar() {
  ...
  const ROLE_NAV_MAP: Record<string, { name: string; href: string; icon: React.ElementType }[]> = {
    ADMIN: [
      ...
      { name: 'Asignación', href: '/horarios-asignacion', icon: Calendar },
    ...
    SECRETARIA_ACADEMICA: [
      ...
      { name: 'Periodos', href: '/periodos', icon: CalendarDays },
      { name: 'Demanda Académica', href: '/demanda', icon: FileText },
      { name: 'Asignación de Horarios', href: '/horarios-asignacion', icon: Calendar },
      { name: 'Horarios', href: '/horarios-visualizacion', icon: Calendar },
      { name: 'Carga Horaria Completa', href: '/carga-horaria-completa', icon: CalendarClock },
      { name: 'Reportes', href: '/reportes', icon: FileText },
    ],
